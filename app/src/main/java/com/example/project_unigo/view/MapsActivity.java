...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        // 1. Tạo tọa độ trường Đại học Yersin Đà Lạt
        LatLng yersinUni = new LatLng(11.966346120694416, 108.4365610530833);

        // 2. Thêm Marker (Ghim đỏ) vào bản đồ
        mMap.addMarker(new MarkerOptions().position(yersinUni).title("Trường ĐH Yersin Đà Lạt"));
